    ...
    for sku in api_response.get('request', {}).get('sku', []):
        ...
        for chunk in chunks:
            if 'details' in chunk:
                ...
                elif group_name in ['PRISM_Legal Information', 'PRISM_Playbook Icons', 'PRISM_Metadata', 'PRISM_System Internal', 'PRISM_Features', 'PRISM_Category', 'PRISM_PSG_Accessories_Headsets[TS]']:
